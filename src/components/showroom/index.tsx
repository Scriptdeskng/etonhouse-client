...
const Showroom = () => {
  return (
    ...
    >
      <div className="p-3">
        <div
          className="w-full h-[590px] flex flex-col items-center justify-center gap-7 text-white"
          style={{
        ...
        >
          <p className="text-2xl font-bold">Visit Our Showroom</p>
          ...
          <p>📍 123 Furniture Lane, Lagos, Nigeria</p>

          <p>📅 Monday – Saturday | 10 AM – 6 PM</p>

          <Button
            text="Get directions"
            className="!bg-white !text-black-400 w-full max-w-[550px] !py-4 !text-base"
          />
        </div>
      </div>
    </PageTitle>
