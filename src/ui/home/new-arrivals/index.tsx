...
import { useNewArrivals } from "@/services/product.service";
              ...
              ? Array(4)
                ...
                .map((_, index) => (
                  <div key={index} className="p-5">
                    <div className="max-w-[280px] xl:max-w-[320px] mx-auto">
                      <Skeleton className="w-full h-[450px] pt-18 rounded-[20px]" />
                    </div>
                  </div>
                ))
